...
# # def add_corridor(self, name, left_image, right_image, end_image, floor_image, ceiling_image, reward_zone_starts, zone_width=470, reward='Right', length=7168, height=768, width=1024):
# Cors.add_corridor('leaf+drops', 'LongLeftA_drops.png', 'LongRightA_drops.png', 'mAEnd.png', 'Long_floorA.png', 'Long_ceiling.png', [7500], zone_width=400, length=10240) 
# Cors.add_corridor('people+drops', 'LongLeftB_drops.png', 'LongRightB_drops.png', 'mBEnd.png', 'Long_floorB.png', 'Long_ceiling.png', [4600], zone_width=400, length=10240)# 2500-3000

# Cors.add_corridor('leaf', 'LongLeftA.png', 'LongRightA.png', 'mAEnd.png', 'Long_floorA.png', 'Long_ceiling.png', [7500], zone_width=400, length=10240) 
# Cors.add_corridor('people', 'LongLeftB.png', 'LongRightB.png', 'mBEnd.png', 'Long_floorB.png', 'Long_ceiling.png', [4600], zone_width=400, length=10240)# 2500-3000
